...
function stripTags(s = '') {
  // Decode entities FIRST so Google's encoded &lt;a href...&gt; markup becomes
  // real tags, THEN strip the tags. (Stripping first would leave the encoded
  // markup behind as literal text.)
